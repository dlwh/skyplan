...
* First paragraph after proof of Claim 4: "In this case, we would not be able
  ...
  I just don't see it, but shouldn't it be in R+? %Aloni: I think he's wrong on this point..
...
Let $m,n \in G^\prime$ such that $m \preceq n$. By construction, neither $m$ or $n$ is $f^*$. Conditions (1) and (3) %\ref
