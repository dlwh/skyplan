...
states $m$ and $n$ with $m \ne n$. We give a general construction
of non-trivial orderings for a large class of problems in a subsequent
section.
...
%domains we consider in this work.} 
...
but these are further afield from our current interest.} To that end, we look at experiments from domains of both
types.
...
implementation is available at \texttt{http://overmind.cs.berkeley.edu/skyplan}.} They differ primarily in the
...
handle both temporal constraints and resources. As these properties
