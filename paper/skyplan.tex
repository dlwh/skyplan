...
/Author (David Hall, Alon Cohen, David Burkett, Dan Klein)}
...
\begin{table*}
    ...
    \scalebox{0.89}{
		...
		\hline
    \Astar 		& 3.1k & 0.27 & 1.0 & 11.7k & 1.34 & 1.0 & {\tiny$>$}809k  & {\tiny$>$}1800 & * & {\tiny$>$}655k & {\tiny$>$}1800& *& {\tiny$>$}768k& {\tiny$>$}1800 &* \\  
	...
	\end{center}
  \vspace{-.15in}
	\caption{Results on the StarCraft domain. Times are in seconds.  Asterisks indicate that \Astar timed out after more than 30
