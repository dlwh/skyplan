...
\begin{definition}[Compatibility]
  ...
  \begin{enumerate}
    ...
    \item $\forall m^\prime \in \mathrm{succ(m)}$ $\exists n^\prime \in
      ...
      $cost(m,m^\prime) \ge cost(n, n^\prime)$, and
...
In this section, we show how to automatically infer a compatible
partial order from a classical planning problem domain's specification,
such as PDDL.~\cite{ghallab1998pddl,fox2003pddl2} In the next
